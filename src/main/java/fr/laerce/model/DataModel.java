...
public class DataModel {
    ...
    public DataModel() {
        ...
        r = new Role(films.get(0), personnes.get(1), "Le juge Rousseau", 2);
        roles.add(r);
        films.get(0).addRole(r);
        personnes.get(1).addRole(r);
        r = new Role(films.get(0), personnes.get(2), "Le juge Rousseau", 3);
        roles.add(r);
        films.get(0).addRole(r);
        personnes.get(2).addRole(r);
        r = new Role(films.get(1), personnes.get(3), "Le juge Rousseau", 1);
        roles.add(r);
